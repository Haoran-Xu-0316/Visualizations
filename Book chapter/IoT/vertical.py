...
#Number of Internet of Things (IoT) connected devices worldwide from 2019 to 2030, by vertical (in millions)
...
pd.set_option('display.unicode.east_asian_width', True)
df = pd.read_excel(r'C:\Users\徐浩然\Desktop\材料\statistic\statistic_id1194682_number-of-iot-connected-devices-worldwide-2019-2030-by-vertical.xlsx', sheet_name='Data',index_col=0)
...
plt.tight_layout()
#plt.savefig(r'C:/Users/徐浩然/Desktop/vertical.png',dpi=400)
plt.show()