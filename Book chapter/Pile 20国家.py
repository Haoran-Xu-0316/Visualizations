...
df1 = pd.read_excel(r'C:\Users\徐浩然\Desktop\材料\20 Pile.xls', sheet_name='Sheet0',index_col=0)
df2= pd.read_excel(r'C:\Users\徐浩然\Desktop\材料\20 Pile.xls', sheet_name='Sheet1',index_col=0)
...
bar.set_ylabel('Number of Public Charging Piles (million)',fontsize=12)
