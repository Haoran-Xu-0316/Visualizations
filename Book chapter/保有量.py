...
df = pd.read_excel(r'C:\Users\徐浩然\Desktop\材料\保有量20个国家20131231-20211231.xls', sheet_name='Sheet0',index_col=0)
...
plt.savefig(r'C:/Users/徐浩然/Desktop/保有量.png',dpi=400)
plt.show()
