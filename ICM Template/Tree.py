...
# data
labels = ['A', 'B', 'C', 'C','D','E','F']
sizes = [500, 250, 120,345, 60,45,35,66]
color = [(40/255,86/255,119/255),(177/255,193/255,204/255),(214/255,156/255,147/255),(229/255,207/255,194/255),(141/255,164/255,147/255),(59/255,72/255,47/255)]
c=plt.get_cmap("coolwarm")

# plot
squarify.plot(sizes, label=labels, pad=False,alpha=0.8,edgecolor='black',linewidth=1,color=color)

# adjustment & save
plt.axis('off')
plt.tight_layout()
plt.savefig(r'C:/Users/徐浩然/Desktop/美赛Figure_Template\1111.png',dpi=400)
