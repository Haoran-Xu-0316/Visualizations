...
# df = pd.read_excel(r'C:\Users\徐浩然\Desktop\correlation.xlsx', sheet_name='商家因素',index_col=0)
...
plt.tight_layout()
heat.set_ylabel('')
# plt.savefig(r'C:/Users/徐浩然/Desktop/美赛Figure_Template\4.png',dpi=400)
