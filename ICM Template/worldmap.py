...
world['2021']
world.plot(cmap='OrRd',legend=True)
plt.axis('off')
plt.tight_layout()
plt.savefig(r'C:/Users/徐浩然/Desktop/美赛Figure_Template\11423411.png',dpi=400)
# df=pd.DataFrame()
# df['name']=world['name']
# df['continent']=world['continent']
# df['iso_a3']=world['iso_a3']
# df['geometry']=world['geometry']
