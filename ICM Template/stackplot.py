...
# plot
fig, ax = plt.subplots()
ax.stackplot(x,y,colors=[(40/255,86/255,119/255),(177/255,193/255,204/255),(214/255,156/255,147/255)])
ax.set(xlim=(0, 8), ylim=(0, 8), xticks=np.arange(0, 9), yticks=np.arange(0, 9))

# adjustment & save
#plt.savefig(r'C:/Users/徐浩然/Desktop/stack.png',dpi=400
plt.tight_layout()
plt.savefig(r'C:/Users/徐浩然/Desktop/美赛Figure_Template\13252343.png',dpi=400)
