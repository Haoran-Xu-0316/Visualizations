...
df2 = pd.read_excel(r'C:\Users\徐浩然\Desktop\汇率货币.xls', sheet_name='Sheet0',index_col=0,parse_dates=[0])
ret2 = np.log(df2 / df2.shift(1))
ret2.to_excel(r'C:\Users\徐浩然\Desktop\rets.xls', sheet_name='Sheet0')
ret2 = ret2.iloc[1:]
print(ret2)
...
signif, fft_theor = wavelet.significance(1.0, dt, scales, 0, alpha,significance_level=0.80,wavelet=mother)
