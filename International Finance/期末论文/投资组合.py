...
# # efficient frontier
plt.scatter(tvols,trets,c=trets/tvols,marker='o')#marker
...
# plt.grid(False)
plt.xlabel('Expected Volatility',weight='bold')
plt.ylabel('Expected Return',weight='bold')


font = fm.FontProperties(family='sans-serif', weight='bold')
