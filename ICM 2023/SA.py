...
df=pd.read_excel(r'C:\Users\徐浩然\Desktop\3GDP.xlsx',sheet_name='Sheet4')
plt.subplots(figsize=(10,5))
ax=sns.lineplot(data=df,palette='coolwarm', linewidth=1)
ax.set_ylabel('GGDP')
...
plt.savefig(r'C:/Users/徐浩然/Desktop/GGDP-Figure/GM.png',dpi=400)
