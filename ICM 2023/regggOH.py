...
c3list=[(40/255,86/255,119/255),(177/255,193/255,204/255),(214/255,156/255,147/255),(229/255,207/255,194/255),c,(59/255,72/255,47/255)]
...
df=pd.read_excel(r'C:\Users\徐浩然\Desktop\3GDP.xlsx',sheet_name='Sheet1')
g=sns.jointplot(x="GGDPGR", y="Ocean Heat GR", data=df,
                  kind="reg", truncate=False,
                  height=7,color=(59/255,72/255,47/255))
# g.plot_marginals(sns.rugplot, color=(141/255,164/255,147/255), height=-.05, clip_on=False)
# g = sns.jointplot(data=df, x="GDP", y="CO",hue='country', color=(177/255,193/255,204/255), height=7)
plt.tight_layout()
plt.savefig(r'C:/Users/徐浩然/Desktop/GGDP-Figure/ggOH.png',dpi=400)
