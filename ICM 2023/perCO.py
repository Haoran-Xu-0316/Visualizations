...
sns.lmplot(x="GGDP", y="CO2 Emissions", data=df,
           lowess=True, line_kws={"color": (59/255,72/255,47/255)},scatter_kws={"color": (141/255,164/255,147/255)})
plt.savefig(r'C:/Users/徐浩然/Desktop/GGDP-Figure/perco.png',dpi=400)
