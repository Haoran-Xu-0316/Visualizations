...
plt.savefig(r's_train.png',dpi=300)
plt.show()
...
plt.ylabel('Feature')
plt.savefig(r'RF_imp.png',dpi=300)
plt.show()
...
plt.savefig(r'dtmap.png',dpi=300)
plt.show()
...
plt.xlabel('Feature Importance')
plt.ylabel('Features')
plt.savefig(r'dt_imp.png',dpi=300)
plt.show()
...
plt.savefig(r's_rf.png',dpi=300)
plt.show()
...
plt.savefig(r's_svm.png',dpi=300)
plt.show()
...
plt.savefig(r's_knn.png',dpi=300)
plt.show()
...
plt.savefig(r's_dt.png',dpi=300)
plt.show()
...
plt.xlabel('Fold')
plt.ylabel('Accuracy')
plt.savefig(r'RF_k.png',dpi=300)
plt.show()
...
plt.xlabel('Fold')
plt.ylabel('Accuracy')
plt.savefig(r'SVM_k.png',dpi=300)
plt.show()
...
plt.xlabel('Fold')
plt.ylabel('Accuracy')
plt.savefig(r'Knn_k.png',dpi=300)
plt.show()
...
plt.xlabel('Fold')
plt.ylabel('Accuracy')
plt.savefig(r'dt_k.png',dpi=300)
plt.show()
