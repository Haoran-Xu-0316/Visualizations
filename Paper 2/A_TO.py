...
net=pd.read_excel(r'C:\Users\徐浩然\Desktop\P2 Results\All_to.xlsx', sheet_name='to',index_col=0,parse_dates=[0])
d=pd.read_excel(r'C:\Users\徐浩然\Desktop\P2 Results\All_to.xlsx', sheet_name='to',parse_dates=[0])

#-----------------------------------------------------------------------------------------------------------------------

P_net=pd.read_excel(r'C:\Users\徐浩然\Desktop\P2 Results\Positive_to.xlsx', sheet_name='to',index_col=0,parse_dates=[0])

#-----------------------------------------------------------------------------------------------------------------------

N_net=pd.read_excel(r'C:\Users\徐浩然\Desktop\P2 Results\Negative_to.xlsx', sheet_name='to',index_col=0,parse_dates=[0])
...
hspace=0.19,
wspace=0.105)
plt.savefig(r'C:/Users/徐浩然/Desktop/Paper 2 Figure/TO.pdf',dpi=400)
...
# hspace=0.19,
# wspace=0.105)
# plt.savefig(r'C:/Users/徐浩然/Desktop/Paper 2 Figure/TODinA.pdf',dpi=400)
#
#
#
#
...
# hspace=0.19,
# wspace=0.105)
# plt.savefig(r'C:/Users/徐浩然/Desktop/Paper 2 Figure/TO%inA.pdf',dpi=400)
#
