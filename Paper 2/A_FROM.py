...
net=pd.read_excel(r'C:\Users\徐浩然\Desktop\P2 Results\All_from.xlsx', sheet_name='from',index_col=0,parse_dates=[0])
d=pd.read_excel(r'C:\Users\徐浩然\Desktop\P2 Results\All_from.xlsx', sheet_name='from',parse_dates=[0])

#-----------------------------------------------------------------------------------------------------------------------

P_net=pd.read_excel(r'C:\Users\徐浩然\Desktop\P2 Results\Positive_from.xlsx', sheet_name='from',index_col=0,parse_dates=[0])

#-----------------------------------------------------------------------------------------------------------------------

N_net=pd.read_excel(r'C:\Users\徐浩然\Desktop\P2 Results\Negative_from.xlsx', sheet_name='from',index_col=0,parse_dates=[0])
...
hspace=0.19,
wspace=0.105)
plt.savefig(r'C:/Users/徐浩然/Desktop/Paper 2 Figure/FROM.pdf',dpi=400)
...
# hspace=0.19,
# wspace=0.105)
# plt.savefig(r'C:/Users/徐浩然/Desktop/Paper 2 Figure/FROMDinA.svg',dpi=400)
#
#
#
#
...
# hspace=0.19,
# wspace=0.105)
# plt.savefig(r'C:/Users/徐浩然/Desktop/Paper 2 Figure/FROM%inA.svg',dpi=400)
#
