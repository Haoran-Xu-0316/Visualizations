...
S=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-EMV.xlsx', sheet_name='Short-Cor',index_col=0,parse_dates=[0])
L=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-EMV.xlsx', sheet_name='Long-Cor',index_col=0,parse_dates=[0])
...
plt.margins(x=0,y=0)
plt.tight_layout()
plt.savefig(r'C:/Users/徐浩然/Desktop/Figure 2-US/DCC-EMV.png',dpi=300)
plt.show()