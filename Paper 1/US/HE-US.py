...
Bond=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\HE.xlsx', sheet_name='Bond',index_col=0,parse_dates=[0])
Oil=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\HE.xlsx', sheet_name='Oil',index_col=0,parse_dates=[0])
BTC=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\HE.xlsx', sheet_name='BTC',index_col=0,parse_dates=[0])
Gold=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\HE.xlsx', sheet_name='Gold',index_col=0,parse_dates=[0])
...
sl=plt.legend(labels=['Bond'],frameon=False,loc='upper right',handlelength=0,prop={'style':'italic','weight':'bold'})
...
sl=plt.legend(labels=['Gold'],frameon=False,loc='upper right',handlelength=0,prop={'style':'italic','weight':'bold'})
plt.legend(frameon=False,loc='lower left',labelspacing=0.15)
plt.gca().add_artist(sl)
plt.xlim(time)
...
#
plt.tight_layout()
plt.savefig(r'C:/Users/徐浩然/Desktop/Figure 2-US/HE.png',dpi=300)
plt.show()
