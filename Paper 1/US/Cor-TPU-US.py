...
S=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-TPU.xlsx', sheet_name='Short-Cor',index_col=0,parse_dates=[0])
L=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-TPU.xlsx', sheet_name='Long-Cor',index_col=0,parse_dates=[0])
...
plt.fill_between(pd.date_range(start='2019-9', end='2020-08', freq='M'), -0.60,0.40, color=C_fill, alpha=0.4, linewidth=0)
plt.margins(x=0,y=0)
...
plt.fill_between(pd.date_range(start='2019-9', end='2020-08', freq='M'), -0.1,0.6, color=C_fill, alpha=0.4, linewidth=0)
plt.margins(x=0,y=0)
...
plt.margins(x=0,y=0)
plt.tight_layout()
plt.savefig(r'C:/Users/徐浩然/Desktop/Figure 2-US/DCC-TPU.png',dpi=300)
plt.show()