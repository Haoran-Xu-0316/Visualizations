...
lBond=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\LPM.xlsx', sheet_name='Bond',index_col=0,parse_dates=[0])
lOil=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\LPM.xlsx', sheet_name='Oil',index_col=0,parse_dates=[0])
lBTC=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\LPM.xlsx', sheet_name='BTC',index_col=0,parse_dates=[0])
lGold=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\LPM.xlsx', sheet_name='Gold',index_col=0,parse_dates=[0])


Bond=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\VaR.xlsx', sheet_name='Bond',index_col=0,parse_dates=[0])
Oil=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\VaR.xlsx', sheet_name='Oil',index_col=0,parse_dates=[0])
BTC=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\VaR.xlsx', sheet_name='BTC',index_col=0,parse_dates=[0])
Gold=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\VaR.xlsx', sheet_name='Gold',index_col=0,parse_dates=[0])
...
#
plt.tight_layout()
plt.savefig(r'C:/Users/徐浩然/Desktop/Figure 2-US/VaRLPM.png',dpi=300)
plt.show()
