...
wb0 = Workbook()
writer = pd.ExcelWriter(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedge_OW.xlsx', engine='openpyxl')
writer.book = wb0
...
wb0.save(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedge_OW.xlsx')
...
wb1 = Workbook()
writer = pd.ExcelWriter(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedge_OHR.xlsx', engine='openpyxl')
writer.book = wb1
...
wb1.save(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedge_OHR.xlsx')

##**********************************************************************************************************************
##**********************************************************************************************************************

# hedged Var--CPU
HVar_gold_CPU=np.square(HR_gold_CPU)*Var_CPU_Gold+Var_CPU_SP500-2*HR_gold_CPU*CoV_CPU_Gold
HVar_oil_CPU=np.square(HR_oil_CPU)*Var_CPU_Oil+Var_CPU_SP500-2*HR_oil_CPU*CoV_CPU_Oil
HVar_btc_CPU=np.square(HR_btc_CPU)*Var_CPU_BTC+Var_CPU_SP500-2*HR_btc_CPU*CoV_CPU_BTC
HVar_bond_CPU=np.square(HR_bond_CPU)*Var_CPU_Bond+Var_CPU_SP500-2*HR_bond_CPU*CoV_CPU_Bond

# ## hedged Var--EMV
HVar_gold_EMV=np.square(HR_gold_EMV)*Var_EMV_Gold+Var_EMV_SP500-2*HR_gold_EMV*CoV_EMV_Gold
HVar_oil_EMV=np.square(HR_oil_EMV)*Var_EMV_Oil+Var_EMV_SP500-2*HR_oil_EMV*CoV_EMV_Oil
HVar_btc_EMV=np.square(HR_btc_EMV)*Var_EMV_BTC+Var_EMV_SP500-2*HR_btc_EMV*CoV_EMV_BTC
HVar_bond_EMV=np.square(HR_bond_EMV)*Var_EMV_Bond+Var_EMV_SP500-2*HR_bond_EMV*CoV_EMV_Bond
#
# ## hedged Var--EPU
HVar_gold_EPU=np.square(HR_gold_EPU)*Var_EPU_Gold+Var_EPU_SP500-2*HR_gold_EPU*CoV_EPU_Gold
HVar_oil_EPU=np.square(HR_oil_EPU)*Var_EPU_Oil+Var_EPU_SP500-2*HR_oil_EPU*CoV_EPU_Oil
HVar_btc_EPU=np.square(HR_btc_EPU)*Var_EPU_BTC+Var_EPU_SP500-2*HR_btc_EPU*CoV_EPU_BTC
HVar_bond_EPU=np.square(HR_bond_EPU)*Var_EPU_Bond+Var_EPU_SP500-2*HR_bond_EPU*CoV_EPU_Bond
#
# ## hedged Var--TPU
HVar_gold_TPU=np.square(HR_gold_TPU)*Var_TPU_Gold+Var_TPU_SP500-2*HR_gold_TPU*CoV_TPU_Gold
HVar_oil_TPU=np.square(HR_oil_TPU)*Var_TPU_Oil+Var_TPU_SP500-2*HR_oil_TPU*CoV_TPU_Oil
HVar_btc_TPU=np.square(HR_btc_TPU)*Var_TPU_BTC+Var_TPU_SP500-2*HR_btc_TPU*CoV_TPU_BTC
HVar_bond_TPU=np.square(HR_bond_TPU)*Var_TPU_Bond+Var_TPU_SP500-2*HR_bond_TPU*CoV_TPU_Bond
#
# ## hedged Var--GPR
HVar_gold_GPR=np.square(HR_gold_GPR)*Var_GPR_Gold+Var_GPR_SP500-2*HR_gold_GPR*CoV_GPR_Gold
HVar_oil_GPR=np.square(HR_oil_GPR)*Var_GPR_Oil+Var_GPR_SP500-2*HR_oil_GPR*CoV_GPR_Oil
HVar_btc_GPR=np.square(HR_btc_GPR)*Var_GPR_BTC+Var_GPR_SP500-2*HR_btc_GPR*CoV_GPR_BTC
HVar_bond_GPR=np.square(HR_bond_GPR)*Var_GPR_Bond+Var_GPR_SP500-2*HR_bond_GPR*CoV_GPR_Bond

# ## hedged Var--BS
HVar_gold_bs=np.square(HR_gold_bs)*Var_bs_Gold+Var_bs_SP500-2*HR_gold_bs*CoV_bs_Gold
HVar_oil_bs=np.square(HR_oil_bs)*Var_bs_Oil+Var_bs_SP500-2*HR_oil_bs*CoV_bs_Oil
HVar_btc_bs=np.square(HR_btc_bs)*Var_bs_BTC+Var_bs_SP500-2*HR_btc_bs*CoV_bs_BTC
HVar_bond_bs=np.square(HR_bond_bs)*Var_bs_Bond+Var_bs_SP500-2*HR_bond_bs*CoV_bs_Bond
...
wb2 = Workbook()
writer = pd.ExcelWriter(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedge_HE.xlsx', engine='openpyxl')
writer.book = wb2
...
wb2.save(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedge_HE.xlsx')
##**********************************************************************************************************************
##**********************************************************************************************************************
...
#
# return--CPU
rt_gold_CPU=StockUS-HR_gold_CPU*Gold
rt_oil_CPU=StockUS-HR_oil_CPU*Oil
rt_btc_CPU=StockUS-HR_btc_CPU*BTC
rt_bond_CPU=StockUS-HR_bond_CPU*Bond
# return--EMV
rt_gold_EMV=StockUS-HR_gold_EMV*Gold
rt_oil_EMV=StockUS-HR_oil_EMV*Oil
rt_btc_EMV=StockUS-HR_btc_EMV*BTC
rt_bond_EMV=StockUS-HR_bond_EMV*Bond
# return--EPU
rt_gold_EPU=StockUS-HR_gold_EPU*Gold
rt_oil_EPU=StockUS-HR_oil_EPU*Oil
rt_btc_EPU=StockUS-HR_btc_EPU*BTC
rt_bond_EPU=StockUS-HR_bond_EPU*Bond
# return--TPU
rt_gold_TPU=StockUS-HR_gold_TPU*Gold
rt_oil_TPU=StockUS-HR_oil_TPU*Oil
rt_btc_TPU=StockUS-HR_btc_TPU*BTC
rt_bond_TPU=StockUS-HR_bond_TPU*Bond
# return--GPR
rt_gold_GPR=StockUS-HR_gold_GPR*Gold
rt_oil_GPR=StockUS-HR_oil_GPR*Oil
rt_btc_GPR=StockUS-HR_btc_GPR*BTC
rt_bond_GPR=StockUS-HR_bond_GPR*Bond
#
# return--bs
rt_gold_bs=StockUS-HR_gold_bs*Gold
rt_oil_bs=StockUS-HR_oil_bs*Oil
rt_btc_bs=StockUS-HR_btc_bs*BTC
rt_bond_bs=StockUS-HR_bond_bs*Bond
##**********************************************************************************************************************
...
wb3 = Workbook()
writer = pd.ExcelWriter(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedge_VaR.xlsx', engine='openpyxl')
writer.book = wb3
...
wb3.save(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedge_VaR.xlsx')
...
wb4 = Workbook()
writer = pd.ExcelWriter(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedge_LPM.xlsx', engine='openpyxl')
writer.book = wb4
...
wb4.save(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedge_LPM.xlsx')
...
wb5.save(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedge_Diversification.xlsx')
...
wb6.save(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedge_Statistics_OWHRHE.xlsx')
...
wb7.save(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedge_Statistics_Cor.xlsx')
plt.show()
