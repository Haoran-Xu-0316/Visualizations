...
HA = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedging Assets\hedging assets.xlsx', sheet_name='All-log',
...
S_CPU = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-CPU.xlsx', sheet_name='Short-Cor',
                      index_col=0, parse_dates=[0])
S_EPU = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-EPU.xlsx', sheet_name='Short-Cor',
                      index_col=0, parse_dates=[0])
S_TPU = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-TPU.xlsx', sheet_name='Short-Cor',
                      index_col=0, parse_dates=[0])
S_EMV = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-EMV.xlsx', sheet_name='Short-Cor',
                      index_col=0, parse_dates=[0])
S_GPR = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-GPR.xlsx', sheet_name='Short-Cor',
                      index_col=0, parse_dates=[0])
S_bs = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-Baseline.xlsx',
                     sheet_name='Short-Cor', index_col=0, parse_dates=[0])

L_CPU = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-CPU.xlsx', sheet_name='Long-Cor',
                      index_col=0, parse_dates=[0])
L_EPU = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-EPU.xlsx', sheet_name='Long-Cor',
                      index_col=0, parse_dates=[0])
L_TPU = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-TPU.xlsx', sheet_name='Long-Cor',
                      index_col=0, parse_dates=[0])
L_EMV = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-EMV.xlsx', sheet_name='Long-Cor',
                      index_col=0, parse_dates=[0])
L_GPR = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-GPR.xlsx', sheet_name='Long-Cor',
                      index_col=0, parse_dates=[0])
...
Var_CPU = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-CPU.xlsx', sheet_name='Var',
                        index_col=0, parse_dates=[0])
Var_EMV = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-EMV.xlsx', sheet_name='Var',
                        index_col=0, parse_dates=[0])
Var_EPU = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-EPU.xlsx', sheet_name='Var',
                        index_col=0, parse_dates=[0])
Var_TPU = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-TPU.xlsx', sheet_name='Var',
                        index_col=0, parse_dates=[0])
Var_GPR = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-GPR.xlsx', sheet_name='Var',
                        index_col=0, parse_dates=[0])
Var_bs = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-Baseline.xlsx', sheet_name='Var',
                       index_col=0, parse_dates=[0])

CoV_CPU = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-CPU.xlsx', sheet_name='Covar',
                        index_col=0, parse_dates=[0])
CoV_EMV = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-EMV.xlsx', sheet_name='Covar',
                        index_col=0, parse_dates=[0])
CoV_EPU = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-EPU.xlsx', sheet_name='Covar',
                        index_col=0, parse_dates=[0])
CoV_TPU = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-TPU.xlsx', sheet_name='Covar',
                        index_col=0, parse_dates=[0])
CoV_GPR = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-GPR.xlsx', sheet_name='Covar',
                        index_col=0, parse_dates=[0])
CoV_bs = pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-Baseline.xlsx', sheet_name='Covar',
                       index_col=0, parse_dates=[0])

## Var & CoV----CPU------------------------------------------------------------------------------------------------------------
Var_CPU_SP500 = Var_CPU.iloc[:, 0]
...
## CPU OW---------------------------------------------------------------------------------------------------------------
Hedge_gold_CPU_OW = (Var_CPU_SP500 - CoV_CPU_Gold) / (Var_CPU_SP500 + Var_CPU_Gold - 2 * CoV_CPU_Gold)
Hedge_oil_CPU_OW = (Var_CPU_SP500 - CoV_CPU_Oil) / (Var_CPU_SP500 + Var_CPU_Oil - 2 * CoV_CPU_Oil)
Hedge_btc_CPU_OW = (Var_CPU_SP500 - CoV_CPU_BTC) / (Var_CPU_SP500 + Var_CPU_BTC - 2 * CoV_CPU_BTC)
Hedge_bond_CPU_OW = (Var_CPU_SP500 - CoV_CPU_Bond) / (Var_CPU_SP500 + Var_CPU_Bond - 2 * CoV_CPU_Bond)
...
## EMV OW---------------------------------------------------------------------------------------------------------------
Hedge_gold_EMV_OW = (Var_EMV_SP500 - CoV_EMV_Gold) / (Var_EMV_SP500 + Var_EMV_Gold - 2 * CoV_EMV_Gold)
Hedge_oil_EMV_OW = (Var_EMV_SP500 - CoV_EMV_Oil) / (Var_EMV_SP500 + Var_EMV_Oil - 2 * CoV_EMV_Oil)
Hedge_btc_EMV_OW = (Var_EMV_SP500 - CoV_EMV_BTC) / (Var_EMV_SP500 + Var_EMV_BTC - 2 * CoV_EMV_BTC)
Hedge_bond_EMV_OW = (Var_EMV_SP500 - CoV_EMV_Bond) / (Var_EMV_SP500 + Var_EMV_Bond - 2 * CoV_EMV_Bond)
...
## EPU OW---------------------------------------------------------------------------------------------------------------
Hedge_gold_EPU_OW = (Var_EPU_SP500 - CoV_EPU_Gold) / (Var_EPU_SP500 + Var_EPU_Gold - 2 * CoV_EPU_Gold)
Hedge_oil_EPU_OW = (Var_EPU_SP500 - CoV_EPU_Oil) / (Var_EPU_SP500 + Var_EPU_Oil - 2 * CoV_EPU_Oil)
Hedge_btc_EPU_OW = (Var_EPU_SP500 - CoV_EPU_BTC) / (Var_EPU_SP500 + Var_EPU_BTC - 2 * CoV_EPU_BTC)
Hedge_bond_EPU_OW = (Var_EPU_SP500 - CoV_EPU_Bond) / (Var_EPU_SP500 + Var_EPU_Bond - 2 * CoV_EPU_Bond)
...
## TPU OW---------------------------------------------------------------------------------------------------------------
Hedge_gold_TPU_OW = (Var_TPU_SP500 - CoV_TPU_Gold) / (Var_TPU_SP500 + Var_TPU_Gold - 2 * CoV_TPU_Gold)
Hedge_oil_TPU_OW = (Var_TPU_SP500 - CoV_TPU_Oil) / (Var_TPU_SP500 + Var_TPU_Oil - 2 * CoV_TPU_Oil)
Hedge_btc_TPU_OW = (Var_TPU_SP500 - CoV_TPU_BTC) / (Var_TPU_SP500 + Var_TPU_BTC - 2 * CoV_TPU_BTC)
Hedge_bond_TPU_OW = (Var_TPU_SP500 - CoV_TPU_Bond) / (Var_TPU_SP500 + Var_TPU_Bond - 2 * CoV_TPU_Bond)
...
## GPR OW---------------------------------------------------------------------------------------------------------------
Hedge_gold_GPR_OW = (Var_GPR_SP500 - CoV_GPR_Gold) / (Var_GPR_SP500 + Var_GPR_Gold - 2 * CoV_GPR_Gold)
Hedge_oil_GPR_OW = (Var_GPR_SP500 - CoV_GPR_Oil) / (Var_GPR_SP500 + Var_GPR_Oil - 2 * CoV_GPR_Oil)
Hedge_btc_GPR_OW = (Var_GPR_SP500 - CoV_GPR_BTC) / (Var_GPR_SP500 + Var_GPR_BTC - 2 * CoV_GPR_BTC)
Hedge_bond_GPR_OW = (Var_GPR_SP500 - CoV_GPR_Bond) / (Var_GPR_SP500 + Var_GPR_Bond - 2 * CoV_GPR_Bond)
...
## BS OW---------------------------------------------------------------------------------------------------------------
Hedge_gold_bs_OW = (Var_bs_SP500 - CoV_bs_Gold) / (Var_bs_SP500 + Var_bs_Gold - 2 * CoV_bs_Gold)
Hedge_oil_bs_OW = (Var_bs_SP500 - CoV_bs_Oil) / (Var_bs_SP500 + Var_bs_Oil - 2 * CoV_bs_Oil)
Hedge_btc_bs_OW = (Var_bs_SP500 - CoV_bs_BTC) / (Var_bs_SP500 + Var_bs_BTC - 2 * CoV_bs_BTC)
Hedge_bond_bs_OW = (Var_bs_SP500 - CoV_bs_Bond) / (Var_bs_SP500 + Var_bs_Bond - 2 * CoV_bs_Bond)
...
wb0 = Workbook()
writer = pd.ExcelWriter(r'C:\Users\徐浩然\Desktop\DCC-data-US\OW.xlsx', engine='openpyxl')
writer.book = wb0
...
wb0.save(r'C:\Users\徐浩然\Desktop\DCC-data-US\OW.xlsx')
...
wb1 = Workbook()
writer = pd.ExcelWriter(r'C:\Users\徐浩然\Desktop\DCC-data-US\OHR.xlsx', engine='openpyxl')
writer.book = wb1
...
wb1.save(r'C:\Users\徐浩然\Desktop\DCC-data-US\OHR.xlsx')
...
# hedged Var--CPU
HVar_gold_CPU = np.square(Hedge_gold_CPU_OW) * Var_CPU_Gold + np.square(
    1 - Hedge_gold_CPU_OW) * Var_CPU_SP500 + 2 * Hedge_gold_CPU_OW * (1 - Hedge_gold_CPU_OW) * CoV_CPU_Gold
HVar_oil_CPU = np.square(Hedge_oil_CPU_OW) * Var_CPU_Oil + np.square(
    1 - Hedge_oil_CPU_OW) * Var_CPU_SP500 + 2 * Hedge_oil_CPU_OW * (1 - Hedge_oil_CPU_OW) * CoV_CPU_Oil
HVar_btc_CPU = np.square(Hedge_btc_CPU_OW) * Var_CPU_BTC + np.square(
    1 - Hedge_btc_CPU_OW) * Var_CPU_SP500 + 2 * Hedge_btc_CPU_OW * (1 - Hedge_btc_CPU_OW) * CoV_CPU_BTC
HVar_bond_CPU = np.square(Hedge_bond_CPU_OW) * Var_CPU_Bond + np.square(
    1 - Hedge_bond_CPU_OW) * Var_CPU_SP500 + 2 * Hedge_bond_CPU_OW * (1 - Hedge_bond_CPU_OW) * CoV_CPU_Bond

# ## hedged Var--EMV
HVar_gold_EMV = np.square(Hedge_gold_EMV_OW) * Var_EMV_Gold + np.square(
    1 - Hedge_gold_EMV_OW) * Var_EMV_SP500 + 2 * Hedge_gold_EMV_OW * (1 - Hedge_gold_EMV_OW) * CoV_EMV_Gold
HVar_oil_EMV = np.square(Hedge_oil_EMV_OW) * Var_EMV_Oil + np.square(
    1 - Hedge_oil_EMV_OW) * Var_EMV_SP500 + 2 * Hedge_oil_EMV_OW * (1 - Hedge_oil_EMV_OW) * CoV_EMV_Oil
HVar_btc_EMV = np.square(Hedge_btc_EMV_OW) * Var_EMV_BTC + np.square(
    1 - Hedge_btc_EMV_OW) * Var_EMV_SP500 + 2 * Hedge_btc_EMV_OW * (1 - Hedge_btc_EMV_OW) * CoV_EMV_BTC
HVar_bond_EMV = np.square(Hedge_bond_EMV_OW) * Var_EMV_Bond + np.square(
    1 - Hedge_bond_EMV_OW) * Var_EMV_SP500 + 2 * Hedge_bond_EMV_OW * (1 - Hedge_bond_EMV_OW) * CoV_EMV_Bond
#
# ## hedged Var--EPU
HVar_gold_EPU = np.square(Hedge_gold_EPU_OW) * Var_EPU_Gold + np.square(
    1 - Hedge_gold_EPU_OW) * Var_EPU_SP500 + 2 * Hedge_gold_EPU_OW * (1 - Hedge_gold_EPU_OW) * CoV_EPU_Gold
HVar_oil_EPU = np.square(Hedge_oil_EPU_OW) * Var_EPU_Oil + np.square(
    1 - Hedge_oil_EPU_OW) * Var_EPU_SP500 + 2 * Hedge_oil_EPU_OW * (1 - Hedge_oil_EPU_OW) * CoV_EPU_Oil
HVar_btc_EPU = np.square(Hedge_btc_EPU_OW) * Var_EPU_BTC + np.square(
    1 - Hedge_btc_EPU_OW) * Var_EPU_SP500 + 2 * Hedge_btc_EPU_OW * (1 - Hedge_btc_EPU_OW) * CoV_EPU_BTC
HVar_bond_EPU = np.square(Hedge_bond_EPU_OW) * Var_EPU_Bond + np.square(
    1 - Hedge_bond_EPU_OW) * Var_EPU_SP500 + 2 * Hedge_bond_EPU_OW * (1 - Hedge_bond_EPU_OW) * CoV_EPU_Bond
#
# ## hedged Var--TPU
HVar_gold_TPU = np.square(Hedge_gold_TPU_OW) * Var_TPU_Gold + np.square(
    1 - Hedge_gold_TPU_OW) * Var_TPU_SP500 + 2 * Hedge_gold_TPU_OW * (1 - Hedge_gold_TPU_OW) * CoV_TPU_Gold
HVar_oil_TPU = np.square(Hedge_oil_TPU_OW) * Var_TPU_Oil + np.square(
    1 - Hedge_oil_TPU_OW) * Var_TPU_SP500 + 2 * Hedge_oil_TPU_OW * (1 - Hedge_oil_TPU_OW) * CoV_TPU_Oil
HVar_btc_TPU = np.square(Hedge_btc_TPU_OW) * Var_TPU_BTC + np.square(
    1 - Hedge_btc_TPU_OW) * Var_TPU_SP500 + 2 * Hedge_btc_TPU_OW * (1 - Hedge_btc_TPU_OW) * CoV_TPU_BTC
HVar_bond_TPU = np.square(Hedge_bond_TPU_OW) * Var_TPU_Bond + np.square(
    1 - Hedge_bond_TPU_OW) * Var_TPU_SP500 + 2 * Hedge_bond_TPU_OW * (1 - Hedge_bond_TPU_OW) * CoV_TPU_Bond
#
# ## hedged Var--GPR
HVar_gold_GPR = np.square(Hedge_gold_GPR_OW) * Var_GPR_Gold + np.square(
    1 - Hedge_gold_GPR_OW) * Var_GPR_SP500 + 2 * Hedge_gold_GPR_OW * (1 - Hedge_gold_GPR_OW) * CoV_GPR_Gold
HVar_oil_GPR = np.square(Hedge_oil_GPR_OW) * Var_GPR_Oil + np.square(
    1 - Hedge_oil_GPR_OW) * Var_GPR_SP500 + 2 * Hedge_oil_GPR_OW * (1 - Hedge_oil_GPR_OW) * CoV_GPR_Oil
HVar_btc_GPR = np.square(Hedge_btc_GPR_OW) * Var_GPR_BTC + np.square(
    1 - Hedge_btc_GPR_OW) * Var_GPR_SP500 + 2 * Hedge_btc_GPR_OW * (1 - Hedge_btc_GPR_OW) * CoV_GPR_BTC
HVar_bond_GPR = np.square(Hedge_bond_GPR_OW) * Var_GPR_Bond + np.square(
    1 - Hedge_bond_GPR_OW) * Var_GPR_SP500 + 2 * Hedge_bond_GPR_OW * (1 - Hedge_bond_GPR_OW) * CoV_GPR_Bond

# ## hedged Var--BS
HVar_gold_bs = np.square(Hedge_gold_bs_OW) * Var_bs_Gold + np.square(
    1 - Hedge_gold_bs_OW) * Var_bs_SP500 + 2 * Hedge_gold_bs_OW * (1 - Hedge_gold_bs_OW) * CoV_bs_Gold
HVar_oil_bs = np.square(Hedge_oil_bs_OW) * Var_bs_Oil + np.square(
    1 - Hedge_oil_bs_OW) * Var_bs_SP500 + 2 * Hedge_oil_bs_OW * (1 - Hedge_oil_bs_OW) * CoV_bs_Oil
HVar_btc_bs = np.square(Hedge_btc_bs_OW) * Var_bs_BTC + np.square(
    1 - Hedge_btc_bs_OW) * Var_bs_SP500 + 2 * Hedge_btc_bs_OW * (1 - Hedge_btc_bs_OW) * CoV_bs_BTC
HVar_bond_bs = np.square(Hedge_bond_bs_OW) * Var_bs_Bond + np.square(
    1 - Hedge_bond_bs_OW) * Var_bs_SP500 + 2 * Hedge_bond_bs_OW * (1 - Hedge_bond_bs_OW) * CoV_bs_Bond
...
##HE-CPU
HE_gold_CPU = 1 - (HVar_gold_CPU / Var_CPU_SP500)
HE_oil_CPU = 1 - (HVar_oil_CPU / Var_CPU_SP500)
HE_btc_CPU = 1 - (HVar_btc_CPU / Var_CPU_SP500)
HE_bond_CPU = 1 - (HVar_bond_CPU / Var_CPU_SP500)

##HE-EMV
HE_gold_EMV = 1 - (HVar_gold_EMV / Var_EMV_SP500)
HE_oil_EMV = 1 - (HVar_oil_EMV / Var_EMV_SP500)
HE_btc_EMV = 1 - (HVar_btc_EMV / Var_EMV_SP500)
HE_bond_EMV = 1 - (HVar_bond_EMV / Var_EMV_SP500)

##HE-EPU
HE_gold_EPU = 1 - (HVar_gold_EPU / Var_EPU_SP500)
HE_oil_EPU = 1 - (HVar_oil_EPU / Var_EPU_SP500)
HE_btc_EPU = 1 - (HVar_btc_EPU / Var_EPU_SP500)
HE_bond_EPU = 1 - (HVar_bond_EPU / Var_EPU_SP500)

##HE-TPU
HE_gold_TPU = 1 - (HVar_gold_TPU / Var_TPU_SP500)
HE_oil_TPU = 1 - (HVar_oil_TPU / Var_TPU_SP500)
HE_btc_TPU = 1 - (HVar_btc_TPU / Var_TPU_SP500)
HE_bond_TPU = 1 - (HVar_bond_TPU / Var_TPU_SP500)

##HE-GPR
HE_gold_GPR = 1 - (HVar_gold_GPR / Var_GPR_SP500)
HE_oil_GPR = 1 - (HVar_oil_GPR / Var_GPR_SP500)
HE_btc_GPR = 1 - (HVar_btc_GPR / Var_GPR_SP500)
HE_bond_GPR = 1 - (HVar_bond_GPR / Var_GPR_SP500)

##HE-BS
HE_gold_bs = 1 - (HVar_gold_bs / Var_bs_SP500)
HE_oil_bs = 1 - (HVar_oil_bs / Var_bs_SP500)
HE_btc_bs = 1 - (HVar_btc_bs / Var_bs_SP500)
HE_bond_bs = 1 - (HVar_bond_bs / Var_bs_SP500)
...
wb2 = Workbook()
writer = pd.ExcelWriter(r'C:\Users\徐浩然\Desktop\DCC-data-US\HE.xlsx', engine='openpyxl')
writer.book = wb2
...
wb2.save(r'C:\Users\徐浩然\Desktop\DCC-data-US\HE.xlsx')
##**********************************************************************************************************************
##**********************************************************************************************************************
...
#
# return--CPU
rt_gold_CPU = Hedge_gold_CPU_OW * Gold + (1 - Hedge_gold_CPU_OW) * StockUS
rt_oil_CPU = Hedge_oil_CPU_OW * Oil + (1 - Hedge_oil_CPU_OW) * StockUS
rt_btc_CPU = Hedge_btc_CPU_OW * BTC + (1 - Hedge_btc_CPU_OW) * StockUS
rt_bond_CPU = Hedge_bond_CPU_OW * Bond + (1 - Hedge_bond_CPU_OW) * StockUS
# return--EMV
rt_gold_EMV = Hedge_gold_EMV_OW * Gold + (1 - Hedge_gold_EMV_OW) * StockUS
rt_oil_EMV = Hedge_oil_EMV_OW * Oil + (1 - Hedge_oil_EMV_OW) * StockUS
rt_btc_EMV = Hedge_btc_EMV_OW * BTC + (1 - Hedge_btc_EMV_OW) * StockUS
rt_bond_EMV = Hedge_bond_EMV_OW * Bond + (1 - Hedge_bond_EMV_OW) * StockUS
# return--EPU
rt_gold_EPU = Hedge_gold_EPU_OW * Gold + (1 - Hedge_gold_EPU_OW) * StockUS
rt_oil_EPU = Hedge_oil_EPU_OW * Oil + (1 - Hedge_oil_EPU_OW) * StockUS
rt_btc_EPU = Hedge_btc_EPU_OW * BTC + (1 - Hedge_btc_EPU_OW) * StockUS
rt_bond_EPU = Hedge_bond_EPU_OW * Bond + (1 - Hedge_bond_EPU_OW) * StockUS
# return--TPU
rt_gold_TPU = Hedge_gold_TPU_OW * Gold + (1 - Hedge_gold_TPU_OW) * StockUS
rt_oil_TPU = Hedge_oil_TPU_OW * Oil + (1 - Hedge_oil_TPU_OW) * StockUS
rt_btc_TPU = Hedge_btc_TPU_OW * BTC + (1 - Hedge_btc_TPU_OW) * StockUS
rt_bond_TPU = Hedge_bond_TPU_OW * Bond + (1 - Hedge_bond_TPU_OW) * StockUS
# return--GPR
rt_gold_GPR = Hedge_gold_GPR_OW * Gold + (1 - Hedge_gold_GPR_OW) * StockUS
rt_oil_GPR = Hedge_oil_GPR_OW * Oil + (1 - Hedge_oil_GPR_OW) * StockUS
rt_btc_GPR = Hedge_btc_GPR_OW * BTC + (1 - Hedge_btc_GPR_OW) * StockUS
rt_bond_GPR = Hedge_bond_GPR_OW * Bond + (1 - Hedge_bond_GPR_OW) * StockUS
# return--BS
rt_gold_bs = Hedge_gold_bs_OW * Gold + (1 - Hedge_gold_bs_OW) * StockUS
rt_oil_bs = Hedge_oil_bs_OW * Oil + (1 - Hedge_oil_bs_OW) * StockUS
rt_btc_bs = Hedge_btc_bs_OW * BTC + (1 - Hedge_btc_bs_OW) * StockUS
rt_bond_bs = Hedge_bond_bs_OW * Bond + (1 - Hedge_bond_bs_OW) * StockUS
#
...
SVaR_stock_CPU = qs.stats.value_at_risk(StockUS)
...
SES_stock_CPU = qs.stats.expected_shortfall(StockUS)
...
LPM_stock_CPU = np.maximum(-StockUS, 0)
...
SVaR_stock_EMV = qs.stats.value_at_risk(StockUS)
...
SES_stock_EMV = qs.stats.expected_shortfall(StockUS)
...
LPM_stock_EMV = np.maximum(-StockUS, 0)
...
SVaR_stock_EPU = qs.stats.value_at_risk(StockUS)
...
SES_stock_EPU = qs.stats.expected_shortfall(StockUS)
...
LPM_stock_EPU = np.maximum(-StockUS, 0)
...
SVaR_stock_TPU = qs.stats.value_at_risk(StockUS)
...
SES_stock_TPU = qs.stats.expected_shortfall(StockUS)
...
LPM_stock_TPU = np.maximum(-StockUS, 0)
...
SVaR_stock_GPR = qs.stats.value_at_risk(StockUS)
...
SES_stock_GPR = qs.stats.expected_shortfall(StockUS)
...
LPM_stock_GPR = np.maximum(-StockUS, 0)
...
SVaR_stock_bs = qs.stats.value_at_risk(StockUS)
...
SES_stock_bs = qs.stats.expected_shortfall(StockUS)
...
LPM_stock_bs = np.maximum(-StockUS, 0)
...
wb3 = Workbook()
writer = pd.ExcelWriter(r'C:\Users\徐浩然\Desktop\DCC-data-US\VaR.xlsx', engine='openpyxl')
writer.book = wb3
...
wb3.save(r'C:\Users\徐浩然\Desktop\DCC-data-US\VaR.xlsx')
...
wb4 = Workbook()
writer = pd.ExcelWriter(r'C:\Users\徐浩然\Desktop\DCC-data-US\LPM.xlsx', engine='openpyxl')
writer.book = wb4
...
wb4.save(r'C:\Users\徐浩然\Desktop\DCC-data-US\LPM.xlsx')
...
wb5.save(r'C:\Users\徐浩然\Desktop\DCC-data-US\Diversification.xlsx')
...
wb6.save(r'C:\Users\徐浩然\Desktop\DCC-data-US\Statistics_OWHRHE.xlsx')
...
wb7.save(r'C:\Users\徐浩然\Desktop\DCC-data-US\Statistics_Cor.xlsx')
plt.show()
