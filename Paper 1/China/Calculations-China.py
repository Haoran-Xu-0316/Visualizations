...
S_CPU=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-CPU.xlsx', sheet_name='Short-Cor',index_col=0,parse_dates=[0])
S_EPU=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-EPU.xlsx', sheet_name='Short-Cor',index_col=0,parse_dates=[0])
S_TPU=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-TPU.xlsx', sheet_name='Short-Cor',index_col=0,parse_dates=[0])
S_EMV=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-EMV.xlsx', sheet_name='Short-Cor',index_col=0,parse_dates=[0])
S_GPR=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-GPR.xlsx', sheet_name='Short-Cor',index_col=0,parse_dates=[0])
S_bs=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-Baseline.xlsx', sheet_name='Short-Cor',index_col=0,parse_dates=[0])

L_CPU=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-CPU.xlsx', sheet_name='Long-Cor',index_col=0,parse_dates=[0])
L_EPU=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-EPU.xlsx', sheet_name='Long-Cor',index_col=0,parse_dates=[0])
L_TPU=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-TPU.xlsx', sheet_name='Long-Cor',index_col=0,parse_dates=[0])
L_EMV=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-EMV.xlsx', sheet_name='Long-Cor',index_col=0,parse_dates=[0])
L_GPR=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-GPR.xlsx', sheet_name='Long-Cor',index_col=0,parse_dates=[0])
...
Var_CPU=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-CPU.xlsx', sheet_name='Var',index_col=0,parse_dates=[0])
Var_EMV=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-EMV.xlsx', sheet_name='Var',index_col=0,parse_dates=[0])
Var_EPU=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-EPU.xlsx', sheet_name='Var',index_col=0,parse_dates=[0])
Var_TPU=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-TPU.xlsx', sheet_name='Var',index_col=0,parse_dates=[0])
Var_GPR=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-GPR.xlsx', sheet_name='Var',index_col=0,parse_dates=[0])
Var_bs=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-Baseline.xlsx', sheet_name='Var',index_col=0,parse_dates=[0])

CoV_CPU=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-CPU.xlsx', sheet_name='Covar',index_col=0,parse_dates=[0])
CoV_EMV=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-EMV.xlsx', sheet_name='Covar',index_col=0,parse_dates=[0])
CoV_EPU=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-EPU.xlsx', sheet_name='Covar',index_col=0,parse_dates=[0])
CoV_TPU=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-TPU.xlsx', sheet_name='Covar',index_col=0,parse_dates=[0])
CoV_GPR=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-GPR.xlsx', sheet_name='Covar',index_col=0,parse_dates=[0])
CoV_bs=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-Baseline.xlsx', sheet_name='Covar',index_col=0,parse_dates=[0])
...
OW_Gold = pd.concat([Hedge_gold_TPU_OW, Hedge_gold_EMV_OW,Hedge_gold_EPU_OW,Hedge_gold_GPR_OW,Hedge_gold_CPU_OW,Hedge_gold_bs_OW], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)
OW_Oil = pd.concat([Hedge_oil_TPU_OW, Hedge_oil_EMV_OW,Hedge_oil_EPU_OW,Hedge_oil_GPR_OW,Hedge_oil_CPU_OW,Hedge_oil_bs_OW], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)
OW_BTC = pd.concat([Hedge_btc_TPU_OW, Hedge_btc_EMV_OW,Hedge_btc_EPU_OW,Hedge_btc_GPR_OW,Hedge_btc_CPU_OW,Hedge_btc_bs_OW], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)
OW_Bond = pd.concat([Hedge_bond_TPU_OW, Hedge_bond_EMV_OW,Hedge_bond_EPU_OW,Hedge_bond_GPR_OW,Hedge_bond_CPU_OW,Hedge_bond_bs_OW], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)


wb0 = Workbook()
writer = pd.ExcelWriter(r'C:\Users\徐浩然\Desktop\DCC-data-China\OW.xlsx', engine='openpyxl')
writer.book = wb0
...
wb0.save(r'C:\Users\徐浩然\Desktop\DCC-data-China\OW.xlsx')
...
#-----------------------------------------------------------------------------------------------------------------------
HR_Gold = pd.concat([HR_gold_TPU, HR_gold_EMV,HR_gold_EPU,HR_gold_GPR,HR_gold_CPU,HR_gold_bs], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)
HR_Oil = pd.concat([HR_oil_TPU, HR_oil_EMV,HR_oil_EPU,HR_oil_GPR,HR_oil_CPU,HR_oil_bs], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)
HR_BTC = pd.concat([HR_btc_TPU, HR_btc_EMV,HR_btc_EPU,HR_btc_GPR,HR_btc_CPU,HR_btc_bs], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)
HR_Bond = pd.concat([HR_bond_TPU, HR_bond_EMV,HR_bond_EPU,HR_bond_GPR,HR_bond_CPU,HR_bond_bs], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)

wb1 = Workbook()
writer = pd.ExcelWriter(r'C:\Users\徐浩然\Desktop\DCC-data-China\OHR.xlsx', engine='openpyxl')
writer.book = wb1
...
wb1.save(r'C:\Users\徐浩然\Desktop\DCC-data-China\OHR.xlsx')
...
# hedged Var--CPU
HVar_gold_CPU=np.square(Hedge_gold_CPU_OW)*Var_CPU_Gold+np.square(1-Hedge_gold_CPU_OW)*Var_CPU_CSI300+2*Hedge_gold_CPU_OW*(1-Hedge_gold_CPU_OW)*CoV_CPU_Gold
HVar_oil_CPU=np.square(Hedge_oil_CPU_OW)*Var_CPU_Oil+np.square(1-Hedge_oil_CPU_OW)*Var_CPU_CSI300+2*Hedge_oil_CPU_OW*(1-Hedge_oil_CPU_OW)*CoV_CPU_Oil
HVar_btc_CPU=np.square(Hedge_btc_CPU_OW)*Var_CPU_BTC+np.square(1-Hedge_btc_CPU_OW)*Var_CPU_CSI300+2*Hedge_btc_CPU_OW*(1-Hedge_btc_CPU_OW)*CoV_CPU_BTC
HVar_bond_CPU=np.square(Hedge_bond_CPU_OW)*Var_CPU_Bond+np.square(1-Hedge_bond_CPU_OW)*Var_CPU_CSI300+2*Hedge_bond_CPU_OW*(1-Hedge_bond_CPU_OW)*CoV_CPU_Bond

# ## hedged Var--EMV
HVar_gold_EMV=np.square(Hedge_gold_EMV_OW)*Var_EMV_Gold+np.square(1-Hedge_gold_EMV_OW)*Var_EMV_CSI300+2*Hedge_gold_EMV_OW*(1-Hedge_gold_EMV_OW)*CoV_EMV_Gold
HVar_oil_EMV=np.square(Hedge_oil_EMV_OW)*Var_EMV_Oil+np.square(1-Hedge_oil_EMV_OW)*Var_EMV_CSI300+2*Hedge_oil_EMV_OW*(1-Hedge_oil_EMV_OW)*CoV_EMV_Oil
HVar_btc_EMV=np.square(Hedge_btc_EMV_OW)*Var_EMV_BTC+np.square(1-Hedge_btc_EMV_OW)*Var_EMV_CSI300+2*Hedge_btc_EMV_OW*(1-Hedge_btc_EMV_OW)*CoV_EMV_BTC
HVar_bond_EMV=np.square(Hedge_bond_EMV_OW)*Var_EMV_Bond+np.square(1-Hedge_bond_EMV_OW)*Var_EMV_CSI300+2*Hedge_bond_EMV_OW*(1-Hedge_bond_EMV_OW)*CoV_EMV_Bond
#
# ## hedged Var--EPU
HVar_gold_EPU=np.square(Hedge_gold_EPU_OW)*Var_EPU_Gold+np.square(1-Hedge_gold_EPU_OW)*Var_EPU_CSI300+2*Hedge_gold_EPU_OW*(1-Hedge_gold_EPU_OW)*CoV_EPU_Gold
HVar_oil_EPU=np.square(Hedge_oil_EPU_OW)*Var_EPU_Oil+np.square(1-Hedge_oil_EPU_OW)*Var_EPU_CSI300+2*Hedge_oil_EPU_OW*(1-Hedge_oil_EPU_OW)*CoV_EPU_Oil
HVar_btc_EPU=np.square(Hedge_btc_EPU_OW)*Var_EPU_BTC+np.square(1-Hedge_btc_EPU_OW)*Var_EPU_CSI300+2*Hedge_btc_EPU_OW*(1-Hedge_btc_EPU_OW)*CoV_EPU_BTC
HVar_bond_EPU=np.square(Hedge_bond_EPU_OW)*Var_EPU_Bond+np.square(1-Hedge_bond_EPU_OW)*Var_EPU_CSI300+2*Hedge_bond_EPU_OW*(1-Hedge_bond_EPU_OW)*CoV_EPU_Bond
#
# ## hedged Var--TPU
HVar_gold_TPU=np.square(Hedge_gold_TPU_OW)*Var_TPU_Gold+np.square(1-Hedge_gold_TPU_OW)*Var_TPU_CSI300+2*Hedge_gold_TPU_OW*(1-Hedge_gold_TPU_OW)*CoV_TPU_Gold
HVar_oil_TPU=np.square(Hedge_oil_TPU_OW)*Var_TPU_Oil+np.square(1-Hedge_oil_TPU_OW)*Var_TPU_CSI300+2*Hedge_oil_TPU_OW*(1-Hedge_oil_TPU_OW)*CoV_TPU_Oil
HVar_btc_TPU=np.square(Hedge_btc_TPU_OW)*Var_TPU_BTC+np.square(1-Hedge_btc_TPU_OW)*Var_TPU_CSI300+2*Hedge_btc_TPU_OW*(1-Hedge_btc_TPU_OW)*CoV_TPU_BTC
HVar_bond_TPU=np.square(Hedge_bond_TPU_OW)*Var_TPU_Bond+np.square(1-Hedge_bond_TPU_OW)*Var_TPU_CSI300+2*Hedge_bond_TPU_OW*(1-Hedge_bond_TPU_OW)*CoV_TPU_Bond
#
# ## hedged Var--GPR
HVar_gold_GPR=np.square(Hedge_gold_GPR_OW)*Var_GPR_Gold+np.square(1-Hedge_gold_GPR_OW)*Var_GPR_CSI300+2*Hedge_gold_GPR_OW*(1-Hedge_gold_GPR_OW)*CoV_GPR_Gold
HVar_oil_GPR=np.square(Hedge_oil_GPR_OW)*Var_GPR_Oil+np.square(1-Hedge_oil_GPR_OW)*Var_GPR_CSI300+2*Hedge_oil_GPR_OW*(1-Hedge_oil_GPR_OW)*CoV_GPR_Oil
HVar_btc_GPR=np.square(Hedge_btc_GPR_OW)*Var_GPR_BTC+np.square(1-Hedge_btc_GPR_OW)*Var_GPR_CSI300+2*Hedge_btc_GPR_OW*(1-Hedge_btc_GPR_OW)*CoV_GPR_BTC
HVar_bond_GPR=np.square(Hedge_bond_GPR_OW)*Var_GPR_Bond+np.square(1-Hedge_bond_GPR_OW)*Var_GPR_CSI300+2*Hedge_bond_GPR_OW*(1-Hedge_bond_GPR_OW)*CoV_GPR_Bond



# ## hedged Var--BS
HVar_gold_bs=np.square(Hedge_gold_bs_OW)*Var_bs_Gold+np.square(1-Hedge_gold_bs_OW)*Var_bs_CSI300+2*Hedge_gold_bs_OW*(1-Hedge_gold_bs_OW)*CoV_bs_Gold
HVar_oil_bs=np.square(Hedge_oil_bs_OW)*Var_bs_Oil+np.square(1-Hedge_oil_bs_OW)*Var_bs_CSI300+2*Hedge_oil_bs_OW*(1-Hedge_oil_bs_OW)*CoV_bs_Oil
HVar_btc_bs=np.square(Hedge_btc_bs_OW)*Var_bs_BTC+np.square(1-Hedge_btc_bs_OW)*Var_bs_CSI300+2*Hedge_btc_bs_OW*(1-Hedge_btc_bs_OW)*CoV_bs_BTC
HVar_bond_bs=np.square(Hedge_bond_bs_OW)*Var_bs_Bond+np.square(1-Hedge_bond_bs_OW)*Var_bs_CSI300+2*Hedge_bond_bs_OW*(1-Hedge_bond_bs_OW)*CoV_bs_Bond
...
HE_Gold = pd.concat([HE_gold_TPU, HE_gold_EMV,HE_gold_EPU,HE_gold_GPR,HE_gold_CPU,HE_gold_bs], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)
HE_Oil = pd.concat([HE_oil_TPU, HE_oil_EMV,HE_oil_EPU,HE_oil_GPR,HE_oil_CPU,HE_oil_bs], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)
HE_BTC = pd.concat([HE_btc_TPU, HE_btc_EMV,HE_btc_EPU,HE_btc_GPR,HE_btc_CPU,HE_btc_bs], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)
HE_Bond = pd.concat([HE_bond_TPU, HE_bond_EMV,HE_bond_EPU,HE_bond_GPR,HE_bond_CPU,HE_bond_bs], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)


wb2 = Workbook()
writer = pd.ExcelWriter(r'C:\Users\徐浩然\Desktop\DCC-data-China\HE.xlsx', engine='openpyxl')
writer.book = wb2
...
wb2.save(r'C:\Users\徐浩然\Desktop\DCC-data-China\HE.xlsx')
##**********************************************************************************************************************
##**********************************************************************************************************************
...
#
# return--CPU
rt_gold_CPU=Hedge_gold_CPU_OW*Gold+(1-Hedge_gold_CPU_OW)*StockCH
rt_oil_CPU=Hedge_oil_CPU_OW*Oil+(1-Hedge_oil_CPU_OW)*StockCH
rt_btc_CPU=Hedge_btc_CPU_OW*BTC+(1-Hedge_btc_CPU_OW)*StockCH
rt_bond_CPU=Hedge_bond_CPU_OW*Bond+(1-Hedge_bond_CPU_OW)*StockCH
# return--EMV
rt_gold_EMV=Hedge_gold_EMV_OW*Gold+(1-Hedge_gold_EMV_OW)*StockCH
rt_oil_EMV=Hedge_oil_EMV_OW*Oil+(1-Hedge_oil_EMV_OW)*StockCH
rt_btc_EMV=Hedge_btc_EMV_OW*BTC+(1-Hedge_btc_EMV_OW)*StockCH
rt_bond_EMV=Hedge_bond_EMV_OW*Bond+(1-Hedge_bond_EMV_OW)*StockCH
# return--EPU
rt_gold_EPU=Hedge_gold_EPU_OW*Gold+(1-Hedge_gold_EPU_OW)*StockCH
rt_oil_EPU=Hedge_oil_EPU_OW*Oil+(1-Hedge_oil_EPU_OW)*StockCH
rt_btc_EPU=Hedge_btc_EPU_OW*BTC+(1-Hedge_btc_EPU_OW)*StockCH
rt_bond_EPU=Hedge_bond_EPU_OW*Bond+(1-Hedge_bond_EPU_OW)*StockCH
# return--TPU
rt_gold_TPU=Hedge_gold_TPU_OW*Gold+(1-Hedge_gold_TPU_OW)*StockCH
rt_oil_TPU=Hedge_oil_TPU_OW*Oil+(1-Hedge_oil_TPU_OW)*StockCH
rt_btc_TPU=Hedge_btc_TPU_OW*BTC+(1-Hedge_btc_TPU_OW)*StockCH
rt_bond_TPU=Hedge_bond_TPU_OW*Bond+(1-Hedge_bond_TPU_OW)*StockCH
# return--GPR
rt_gold_GPR=Hedge_gold_GPR_OW*Gold+(1-Hedge_gold_GPR_OW)*StockCH
rt_oil_GPR=Hedge_oil_GPR_OW*Oil+(1-Hedge_oil_GPR_OW)*StockCH
rt_btc_GPR=Hedge_btc_GPR_OW*BTC+(1-Hedge_btc_GPR_OW)*StockCH
rt_bond_GPR=Hedge_bond_GPR_OW*Bond+(1-Hedge_bond_GPR_OW)*StockCH
# return--BS
rt_gold_bs=Hedge_gold_bs_OW*Gold+(1-Hedge_gold_bs_OW)*StockCH
rt_oil_bs=Hedge_oil_bs_OW*Oil+(1-Hedge_oil_bs_OW)*StockCH
rt_btc_bs=Hedge_btc_bs_OW*BTC+(1-Hedge_btc_bs_OW)*StockCH
rt_bond_bs=Hedge_bond_bs_OW*Bond+(1-Hedge_bond_bs_OW)*StockCH
#
...
DVaR_Gold = pd.concat([DVaR_gold_TPU, DVaR_gold_EMV,DVaR_gold_EPU,DVaR_gold_GPR,DVaR_gold_CPU,DVaR_gold_bs], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)
DVaR_Oil = pd.concat([DVaR_oil_TPU, DVaR_oil_EMV,DVaR_oil_EPU,DVaR_oil_GPR,DVaR_oil_CPU,DVaR_oil_bs], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)
DVaR_BTC = pd.concat([DVaR_btc_TPU, DVaR_btc_EMV,DVaR_btc_EPU,DVaR_btc_GPR,DVaR_btc_CPU,DVaR_btc_bs], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)
DVaR_Bond = pd.concat([DVaR_bond_TPU, DVaR_bond_EMV,DVaR_bond_EPU,DVaR_bond_GPR,DVaR_bond_CPU,DVaR_bond_bs], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)


wb3 = Workbook()
writer = pd.ExcelWriter(r'C:\Users\徐浩然\Desktop\DCC-data-China\VaR.xlsx', engine='openpyxl')
writer.book = wb3
...
wb3.save(r'C:\Users\徐浩然\Desktop\DCC-data-China\VaR.xlsx')



LPM_Gold = pd.concat([LPM_gold_TPU, LPM_gold_EMV,LPM_gold_EPU,LPM_gold_GPR,LPM_gold_CPU,LPM_gold_bs], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)
LPM_Oil = pd.concat([LPM_oil_TPU, LPM_oil_EMV,LPM_oil_EPU,LPM_oil_GPR,LPM_oil_CPU,LPM_oil_bs], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)
LPM_BTC = pd.concat([LPM_btc_TPU, LPM_btc_EMV,LPM_btc_EPU,LPM_btc_GPR,LPM_btc_CPU,LPM_btc_bs], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)
LPM_Bond = pd.concat([LPM_bond_TPU, LPM_bond_EMV,LPM_bond_EPU,LPM_bond_GPR,LPM_bond_CPU,LPM_bond_bs], keys=['TPU','EMV','EPU','GPR','CPU','Baseline'], axis=1)


wb4 = Workbook()
writer = pd.ExcelWriter(r'C:\Users\徐浩然\Desktop\DCC-data-China\LPM.xlsx', engine='openpyxl')
writer.book = wb4
...
wb4.save(r'C:\Users\徐浩然\Desktop\DCC-data-China\LPM.xlsx')
...
for index, value in enumerate(['Bond',VReduct_bond_EPU,VReduct_bond_CPU,VReduct_bond_TPU,VReduct_bond_EMV,VReduct_bond_GPR,VReduct_bond_bs], start=1):
    ws5.cell(row=4, column=index, value=value)
for index, value in enumerate(['Gold',VReduct_gold_EPU,VReduct_gold_CPU,VReduct_gold_TPU,VReduct_gold_EMV,VReduct_gold_GPR,VReduct_gold_bs], start=1):
    ws5.cell(row=5, column=index, value=value)
for index, value in enumerate(['Oil',VReduct_oil_EPU,VReduct_oil_CPU,VReduct_oil_TPU,VReduct_oil_EMV,VReduct_oil_GPR,VReduct_oil_bs], start=1):
    ws5.cell(row=6, column=index, value=value)
for index, value in enumerate(['Bitcoin',VReduct_btc_EPU,VReduct_btc_CPU,VReduct_btc_TPU,VReduct_btc_EMV,VReduct_btc_GPR,VReduct_btc_bs], start=1):
    ws5.cell(row=7, column=index, value=value)


for index, value in enumerate(['Bond',ESReduct_bond_EPU,ESReduct_bond_CPU,ESReduct_bond_TPU,ESReduct_bond_EMV,ESReduct_bond_GPR,ESReduct_bond_bs], start=1):
    ws5.cell(row=9, column=index, value=value)
for index, value in enumerate(['Gold',ESReduct_gold_EPU,ESReduct_gold_CPU,ESReduct_gold_TPU,ESReduct_gold_EMV,ESReduct_gold_GPR,ESReduct_gold_bs], start=1):
    ws5.cell(row=10, column=index, value=value)
for index, value in enumerate(['Oil',ESReduct_oil_EPU,ESReduct_oil_CPU,ESReduct_oil_TPU,ESReduct_oil_EMV,ESReduct_oil_GPR,ESReduct_oil_bs], start=1):
    ws5.cell(row=11, column=index, value=value)
for index, value in enumerate(['Bitcoin',ESReduct_btc_EPU,ESReduct_btc_CPU,ESReduct_btc_TPU,ESReduct_btc_EMV,ESReduct_btc_GPR,ESReduct_btc_bs], start=1):
    ws5.cell(row=12, column=index, value=value)

for index, value in enumerate(['Bond',LReduct_bond_EPU,LReduct_bond_CPU,LReduct_bond_TPU,LReduct_bond_EMV,LReduct_bond_GPR,LReduct_bond_bs], start=1):
    ws5.cell(row=14, column=index, value=value)
for index, value in enumerate(['Gold',LReduct_gold_EPU,LReduct_gold_CPU,LReduct_gold_TPU,LReduct_gold_EMV,LReduct_gold_GPR,LReduct_gold_bs], start=1):
    ws5.cell(row=15, column=index, value=value)
for index, value in enumerate(['Oil',LReduct_oil_EPU,LReduct_oil_CPU,LReduct_oil_TPU,LReduct_oil_EMV,LReduct_oil_GPR,LReduct_oil_bs], start=1):
    ws5.cell(row=16, column=index, value=value)
for index, value in enumerate(['Bitcoin',LReduct_btc_EPU,LReduct_btc_CPU,LReduct_btc_TPU,LReduct_btc_EMV,LReduct_btc_GPR,LReduct_btc_bs], start=1):
...
for index, value in enumerate(['Bond',Sharpe_bond_EPU,Sharpe_bond_CPU,Sharpe_bond_TPU,Sharpe_bond_EMV,Sharpe_bond_GPR,Sharpe_bond_bs], start=1):
    ws5.cell(row=19, column=index, value=value)
for index, value in enumerate(['Gold',Sharpe_gold_EPU,Sharpe_gold_CPU,Sharpe_gold_TPU,Sharpe_gold_EMV,Sharpe_gold_GPR,Sharpe_gold_bs], start=1):
    ws5.cell(row=20, column=index, value=value)
for index, value in enumerate(['Oil',Sharpe_oil_EPU,Sharpe_oil_CPU,Sharpe_oil_TPU,Sharpe_oil_EMV,Sharpe_oil_GPR,Sharpe_oil_bs], start=1):
    ws5.cell(row=21, column=index, value=value)
for index, value in enumerate(['Bitcoin',Sharpe_btc_EPU,Sharpe_btc_CPU,Sharpe_btc_TPU,Sharpe_btc_EMV,Sharpe_btc_GPR,Sharpe_btc_bs], start=1):
    ws5.cell(row=22, column=index, value=value)

for index, value in enumerate(['Bond',Sortino_bond_EPU,Sortino_bond_CPU,Sortino_bond_TPU,Sortino_bond_EMV,Sortino_bond_GPR,Sortino_bond_bs], start=1):
    ws5.cell(row=24, column=index, value=value)
for index, value in enumerate(['Gold',Sortino_gold_EPU,Sortino_gold_CPU,Sortino_gold_TPU,Sortino_gold_EMV,Sortino_gold_GPR,Sortino_gold_bs], start=1):
    ws5.cell(row=25, column=index, value=value)
for index, value in enumerate(['Oil',Sortino_oil_EPU,Sortino_oil_CPU,Sortino_oil_TPU,Sortino_oil_EMV,Sortino_oil_GPR,Sortino_oil_bs], start=1):
    ws5.cell(row=26, column=index, value=value)
for index, value in enumerate(['Bitcoin',Sortino_btc_EPU,Sortino_btc_CPU,Sortino_btc_TPU,Sortino_btc_EMV,Sortino_btc_GPR,Sortino_btc_bs], start=1):
    ws5.cell(row=27, column=index, value=value)

for index, value in enumerate(['Bond',Omega_bond_EPU,Omega_bond_CPU,Omega_bond_TPU,Omega_bond_EMV,Omega_bond_GPR,Omega_bond_bs], start=1):
    ws5.cell(row=29, column=index, value=value)
for index, value in enumerate(['Gold',Omega_gold_EPU,Omega_gold_CPU,Omega_gold_TPU,Omega_gold_EMV,Omega_gold_GPR,Omega_gold_bs], start=1):
    ws5.cell(row=30, column=index, value=value)
for index, value in enumerate(['Oil',Omega_oil_EPU,Omega_oil_CPU,Omega_oil_TPU,Omega_oil_EMV,Omega_oil_GPR,Omega_oil_bs], start=1):
    ws5.cell(row=31, column=index, value=value)
for index, value in enumerate(['Bitcoin',Omega_btc_EPU,Omega_btc_CPU,Omega_btc_TPU,Omega_btc_EMV,Omega_btc_GPR,Omega_btc_bs], start=1):
    ws5.cell(row=32, column=index, value=value)

for index, value in enumerate(['Bond',Calmar_bond_EPU,Calmar_bond_CPU,Calmar_bond_TPU,Calmar_bond_EMV,Calmar_bond_GPR,Calmar_bond_bs], start=1):
    ws5.cell(row=34, column=index, value=value)
for index, value in enumerate(['Gold',Calmar_gold_EPU,Calmar_gold_CPU,Calmar_gold_TPU,Calmar_gold_EMV,Calmar_gold_GPR,Calmar_gold_bs], start=1):
    ws5.cell(row=35, column=index, value=value)
for index, value in enumerate(['Oil',Calmar_oil_EPU,Calmar_oil_CPU,Calmar_oil_TPU,Calmar_oil_EMV,Calmar_oil_GPR,Calmar_oil_bs], start=1):
    ws5.cell(row=36, column=index, value=value)
for index, value in enumerate(['Bitcoin',Calmar_btc_EPU,Calmar_btc_CPU,Calmar_btc_TPU,Calmar_btc_EMV,Calmar_btc_GPR,Calmar_btc_bs], start=1):
    ws5.cell(row=37, column=index, value=value)

wb5.save(r'C:\Users\徐浩然\Desktop\DCC-data-China\Diversification.xlsx')
...
for index, value in enumerate(['EPU',Hedge_bond_EPU_OW.mean(),Hedge_bond_EPU_OW.max(),Hedge_bond_EPU_OW.min(),Hedge_bond_EPU_OW.std(),
...
for index, value in enumerate(['CPU',Hedge_bond_CPU_OW.mean(),Hedge_bond_CPU_OW.max(),Hedge_bond_CPU_OW.min(),Hedge_bond_CPU_OW.std(),
...
for index, value in enumerate(['TPU',Hedge_bond_TPU_OW.mean(),Hedge_bond_TPU_OW.max(),Hedge_bond_TPU_OW.min(),Hedge_bond_TPU_OW.std(),
...
for index, value in enumerate(['EMV',Hedge_bond_EMV_OW.mean(),Hedge_bond_EMV_OW.max(),Hedge_bond_EMV_OW.min(),Hedge_bond_EMV_OW.std(),
...
for index, value in enumerate(['GPR',Hedge_bond_GPR_OW.mean(),Hedge_bond_GPR_OW.max(),Hedge_bond_GPR_OW.min(),Hedge_bond_GPR_OW.std(),
...
for index, value in enumerate(['Baseline',Hedge_bond_bs_OW.mean(),Hedge_bond_bs_OW.max(),Hedge_bond_bs_OW.min(),Hedge_bond_bs_OW.std(),
...
for index, value in enumerate(['EPU',Hedge_gold_EPU_OW.mean(),Hedge_gold_EPU_OW.max(),Hedge_gold_EPU_OW.min(),Hedge_gold_EPU_OW.std(),
...
for index, value in enumerate(['CPU',Hedge_gold_CPU_OW.mean(),Hedge_gold_CPU_OW.max(),Hedge_gold_CPU_OW.min(),Hedge_gold_CPU_OW.std(),
...
for index, value in enumerate(['TPU',Hedge_gold_TPU_OW.mean(),Hedge_gold_TPU_OW.max(),Hedge_gold_TPU_OW.min(),Hedge_gold_TPU_OW.std(),
...
for index, value in enumerate(['EMV',Hedge_gold_EMV_OW.mean(),Hedge_gold_EMV_OW.max(),Hedge_gold_EMV_OW.min(),Hedge_gold_EMV_OW.std(),
...
for index, value in enumerate(['GPR',Hedge_gold_GPR_OW.mean(),Hedge_gold_GPR_OW.max(),Hedge_gold_GPR_OW.min(),Hedge_gold_GPR_OW.std(),
...
for index, value in enumerate(['Baseline',Hedge_gold_bs_OW.mean(),Hedge_gold_bs_OW.max(),Hedge_gold_bs_OW.min(),Hedge_gold_bs_OW.std(),
...
for index, value in enumerate(['EPU',Hedge_oil_EPU_OW.mean(),Hedge_oil_EPU_OW.max(),Hedge_oil_EPU_OW.min(),Hedge_oil_EPU_OW.std(),
...
for index, value in enumerate(['CPU',Hedge_oil_CPU_OW.mean(),Hedge_oil_CPU_OW.max(),Hedge_oil_CPU_OW.min(),Hedge_oil_CPU_OW.std(),
...
for index, value in enumerate(['TPU',Hedge_oil_TPU_OW.mean(),Hedge_oil_TPU_OW.max(),Hedge_oil_TPU_OW.min(),Hedge_oil_TPU_OW.std(),
...
for index, value in enumerate(['EMV',Hedge_oil_EMV_OW.mean(),Hedge_oil_EMV_OW.max(),Hedge_oil_EMV_OW.min(),Hedge_oil_EMV_OW.std(),
...
for index, value in enumerate(['GPR',Hedge_oil_GPR_OW.mean(),Hedge_oil_GPR_OW.max(),Hedge_oil_GPR_OW.min(),Hedge_oil_GPR_OW.std(),
...
for index, value in enumerate(['bs',Hedge_oil_bs_OW.mean(),Hedge_oil_bs_OW.max(),Hedge_oil_bs_OW.min(),Hedge_oil_bs_OW.std(),
...
for index, value in enumerate(['EPU',Hedge_btc_EPU_OW.mean(),Hedge_btc_EPU_OW.max(),Hedge_btc_EPU_OW.min(),Hedge_btc_EPU_OW.std(),
...
for index, value in enumerate(['CPU',Hedge_btc_CPU_OW.mean(),Hedge_btc_CPU_OW.max(),Hedge_btc_CPU_OW.min(),Hedge_btc_CPU_OW.std(),
...
for index, value in enumerate(['TPU',Hedge_btc_TPU_OW.mean(),Hedge_btc_TPU_OW.max(),Hedge_btc_TPU_OW.min(),Hedge_btc_TPU_OW.std(),
...
for index, value in enumerate(['EMV',Hedge_btc_EMV_OW.mean(),Hedge_btc_EMV_OW.max(),Hedge_btc_EMV_OW.min(),Hedge_btc_EMV_OW.std(),
...
for index, value in enumerate(['GPR',Hedge_btc_GPR_OW.mean(),Hedge_btc_GPR_OW.max(),Hedge_btc_GPR_OW.min(),Hedge_btc_GPR_OW.std(),
...
for index, value in enumerate(['bs',Hedge_btc_bs_OW.mean(),Hedge_btc_bs_OW.max(),Hedge_btc_bs_OW.min(),Hedge_btc_bs_OW.std(),
...
wb6.save(r'C:\Users\徐浩然\Desktop\DCC-data-China\Statistics_OWHRHE.xlsx')
...
wb7.save(r'C:\Users\徐浩然\Desktop\DCC-data-China\Statistics_Cor.xlsx')
plt.show()
