...
#-----------------------------------------------------------------------------------------------------------------------
HR_Gold = pd.concat([HR_gold_TPU, HR_gold_EMV,HR_gold_EPU,HR_gold_GPR,HR_gold_CPU], keys=['TPU','EMV','EPU','GPR','CPU'], axis=1)
HR_Oil = pd.concat([HR_oil_TPU, HR_oil_EMV,HR_oil_EPU,HR_oil_GPR,HR_oil_CPU], keys=['TPU','EMV','EPU','GPR','CPU'], axis=1)
HR_BTC = pd.concat([HR_btc_TPU, HR_btc_EMV,HR_btc_EPU,HR_btc_GPR,HR_btc_CPU], keys=['TPU','EMV','EPU','GPR','CPU'], axis=1)
HR_Bond = pd.concat([HR_bond_TPU, HR_bond_EMV,HR_bond_EPU,HR_bond_GPR,HR_bond_CPU], keys=['TPU','EMV','EPU','GPR','CPU'], axis=1)
...
HE_Gold = pd.concat([HE_gold_TPU, HE_gold_EMV,HE_gold_EPU,HE_gold_GPR,HE_gold_CPU], keys=['TPU','EMV','EPU','GPR','CPU'], axis=1)
HE_Oil = pd.concat([HE_oil_TPU, HE_oil_EMV,HE_oil_EPU,HE_oil_GPR,HE_oil_CPU], keys=['TPU','EMV','EPU','GPR','CPU'], axis=1)
HE_BTC = pd.concat([HE_btc_TPU, HE_btc_EMV,HE_btc_EPU,HE_btc_GPR,HE_btc_CPU], keys=['TPU','EMV','EPU','GPR','CPU'], axis=1)
HE_Bond = pd.concat([HE_bond_TPU, HE_bond_EMV,HE_bond_EPU,HE_bond_GPR,HE_bond_CPU], keys=['TPU','EMV','EPU','GPR','CPU'], axis=1)
...
DVaR_Gold = pd.concat([DVaR_gold_TPU, DVaR_gold_EMV,DVaR_gold_EPU,DVaR_gold_GPR,DVaR_gold_CPU], keys=['TPU','EMV','EPU','GPR','CPU'], axis=1)
DVaR_Oil = pd.concat([DVaR_oil_TPU, DVaR_oil_EMV,DVaR_oil_EPU,DVaR_oil_GPR,DVaR_oil_CPU], keys=['TPU','EMV','EPU','GPR','CPU'], axis=1)
DVaR_BTC = pd.concat([DVaR_btc_TPU, DVaR_btc_EMV,DVaR_btc_EPU,DVaR_btc_GPR,DVaR_btc_CPU], keys=['TPU','EMV','EPU','GPR','CPU'], axis=1)
DVaR_Bond = pd.concat([DVaR_bond_TPU, DVaR_bond_EMV,DVaR_bond_EPU,DVaR_bond_GPR,DVaR_bond_CPU], keys=['TPU','EMV','EPU','GPR','CPU'], axis=1)
...
LPM_Gold = pd.concat([LPM_gold_TPU, LPM_gold_EMV,LPM_gold_EPU,LPM_gold_GPR,LPM_gold_CPU], keys=['TPU','EMV','EPU','GPR','CPU'], axis=1)
LPM_Oil = pd.concat([LPM_oil_TPU, LPM_oil_EMV,LPM_oil_EPU,LPM_oil_GPR,LPM_oil_CPU], keys=['TPU','EMV','EPU','GPR','CPU'], axis=1)
LPM_BTC = pd.concat([LPM_btc_TPU, LPM_btc_EMV,LPM_btc_EPU,LPM_btc_GPR,LPM_btc_CPU], keys=['TPU','EMV','EPU','GPR','CPU'], axis=1)
LPM_Bond = pd.concat([LPM_bond_TPU, LPM_bond_EMV,LPM_bond_EPU,LPM_bond_GPR,LPM_bond_CPU], keys=['TPU','EMV','EPU','GPR','CPU'], axis=1)
...
for index, value in enumerate(['EPU','CPU','TPU','EMV','GPR'], start=2):
...
for index, value in enumerate(['Bond',VReduct_bond_EPU,VReduct_bond_CPU,VReduct_bond_TPU,VReduct_bond_EMV,VReduct_bond_GPR], start=1):
    ws5.cell(row=4, column=index, value=value)
for index, value in enumerate(['Gold',VReduct_gold_EPU,VReduct_gold_CPU,VReduct_gold_TPU,VReduct_gold_EMV,VReduct_gold_GPR], start=1):
    ws5.cell(row=5, column=index, value=value)
for index, value in enumerate(['Oil',VReduct_oil_EPU,VReduct_oil_CPU,VReduct_oil_TPU,VReduct_oil_EMV,VReduct_oil_GPR], start=1):
    ws5.cell(row=6, column=index, value=value)
for index, value in enumerate(['Bitcoin',VReduct_btc_EPU,VReduct_btc_CPU,VReduct_btc_TPU,VReduct_btc_EMV,VReduct_btc_GPR], start=1):
    ws5.cell(row=7, column=index, value=value)


for index, value in enumerate(['Bond',ESReduct_bond_EPU,ESReduct_bond_CPU,ESReduct_bond_TPU,ESReduct_bond_EMV,ESReduct_bond_GPR], start=1):
    ws5.cell(row=9, column=index, value=value)
for index, value in enumerate(['Gold',ESReduct_gold_EPU,ESReduct_gold_CPU,ESReduct_gold_TPU,ESReduct_gold_EMV,ESReduct_gold_GPR], start=1):
    ws5.cell(row=10, column=index, value=value)
for index, value in enumerate(['Oil',ESReduct_oil_EPU,ESReduct_oil_CPU,ESReduct_oil_TPU,ESReduct_oil_EMV,ESReduct_oil_GPR], start=1):
    ws5.cell(row=11, column=index, value=value)
for index, value in enumerate(['Bitcoin',ESReduct_btc_EPU,ESReduct_btc_CPU,ESReduct_btc_TPU,ESReduct_btc_EMV,ESReduct_btc_GPR], start=1):
    ws5.cell(row=12, column=index, value=value)

for index, value in enumerate(['Bond',LReduct_bond_EPU,LReduct_bond_CPU,LReduct_bond_TPU,LReduct_bond_EMV,LReduct_bond_GPR], start=1):
    ws5.cell(row=14, column=index, value=value)
for index, value in enumerate(['Gold',LReduct_gold_EPU,LReduct_gold_CPU,LReduct_gold_TPU,LReduct_gold_EMV,LReduct_gold_GPR], start=1):
    ws5.cell(row=15, column=index, value=value)
for index, value in enumerate(['Oil',LReduct_oil_EPU,LReduct_oil_CPU,LReduct_oil_TPU,LReduct_oil_EMV,LReduct_oil_GPR], start=1):
    ws5.cell(row=16, column=index, value=value)
for index, value in enumerate(['Bitcoin',LReduct_btc_EPU,LReduct_btc_CPU,LReduct_btc_TPU,LReduct_btc_EMV,LReduct_btc_GPR], start=1):
...
for index, value in enumerate(['Bond',Sharpe_bond_EPU,Sharpe_bond_CPU,Sharpe_bond_TPU,Sharpe_bond_EMV,Sharpe_bond_GPR], start=1):
    ws5.cell(row=19, column=index, value=value)
for index, value in enumerate(['Gold',Sharpe_gold_EPU,Sharpe_gold_CPU,Sharpe_gold_TPU,Sharpe_gold_EMV,Sharpe_gold_GPR], start=1):
    ws5.cell(row=20, column=index, value=value)
for index, value in enumerate(['Oil',Sharpe_oil_EPU,Sharpe_oil_CPU,Sharpe_oil_TPU,Sharpe_oil_EMV,Sharpe_oil_GPR], start=1):
    ws5.cell(row=21, column=index, value=value)
for index, value in enumerate(['Bitcoin',Sharpe_btc_EPU,Sharpe_btc_CPU,Sharpe_btc_TPU,Sharpe_btc_EMV,Sharpe_btc_GPR], start=1):
    ws5.cell(row=22, column=index, value=value)

for index, value in enumerate(['Bond',Sortino_bond_EPU,Sortino_bond_CPU,Sortino_bond_TPU,Sortino_bond_EMV,Sortino_bond_GPR], start=1):
    ws5.cell(row=24, column=index, value=value)
for index, value in enumerate(['Gold',Sortino_gold_EPU,Sortino_gold_CPU,Sortino_gold_TPU,Sortino_gold_EMV,Sortino_gold_GPR], start=1):
    ws5.cell(row=25, column=index, value=value)
for index, value in enumerate(['Oil',Sortino_oil_EPU,Sortino_oil_CPU,Sortino_oil_TPU,Sortino_oil_EMV,Sortino_oil_GPR], start=1):
    ws5.cell(row=26, column=index, value=value)
for index, value in enumerate(['Bitcoin',Sortino_btc_EPU,Sortino_btc_CPU,Sortino_btc_TPU,Sortino_btc_EMV,Sortino_btc_GPR], start=1):
    ws5.cell(row=27, column=index, value=value)

for index, value in enumerate(['Bond',Omega_bond_EPU,Omega_bond_CPU,Omega_bond_TPU,Omega_bond_EMV,Omega_bond_GPR], start=1):
    ws5.cell(row=29, column=index, value=value)
for index, value in enumerate(['Gold',Omega_gold_EPU,Omega_gold_CPU,Omega_gold_TPU,Omega_gold_EMV,Omega_gold_GPR], start=1):
    ws5.cell(row=30, column=index, value=value)
for index, value in enumerate(['Oil',Omega_oil_EPU,Omega_oil_CPU,Omega_oil_TPU,Omega_oil_EMV,Omega_oil_GPR], start=1):
    ws5.cell(row=31, column=index, value=value)
for index, value in enumerate(['Bitcoin',Omega_btc_EPU,Omega_btc_CPU,Omega_btc_TPU,Omega_btc_EMV,Omega_btc_GPR], start=1):
    ws5.cell(row=32, column=index, value=value)

for index, value in enumerate(['Bond',Calmar_bond_EPU,Calmar_bond_CPU,Calmar_bond_TPU,Calmar_bond_EMV,Calmar_bond_GPR], start=1):
    ws5.cell(row=34, column=index, value=value)
for index, value in enumerate(['Gold',Calmar_gold_EPU,Calmar_gold_CPU,Calmar_gold_TPU,Calmar_gold_EMV,Calmar_gold_GPR], start=1):
    ws5.cell(row=35, column=index, value=value)
for index, value in enumerate(['Oil',Calmar_oil_EPU,Calmar_oil_CPU,Calmar_oil_TPU,Calmar_oil_EMV,Calmar_oil_GPR], start=1):
    ws5.cell(row=36, column=index, value=value)
for index, value in enumerate(['Bitcoin',Calmar_btc_EPU,Calmar_btc_CPU,Calmar_btc_TPU,Calmar_btc_EMV,Calmar_btc_GPR], start=1):
...
for index, value in enumerate(['EPU',Hedge_gold_EPU_OW.mean(),Hedge_gold_EPU_OW.max(),Hedge_gold_EPU_OW.min(),Hedge_gold_EPU_OW.std(),
    ...
    ws6.cell(row=10, column=index, value=value)
...
for index, value in enumerate(['CPU',Hedge_oil_CPU_OW.mean(),Hedge_oil_CPU_OW.max(),Hedge_oil_CPU_OW.min(),Hedge_oil_CPU_OW.std(),
    ...
    ws6.cell(row=17, column=index, value=value)
...
for index, value in enumerate(['TPU',Hedge_btc_TPU_OW.mean(),Hedge_btc_TPU_OW.max(),Hedge_btc_TPU_OW.min(),Hedge_btc_TPU_OW.std(),
    ...
    ws6.cell(row=24, column=index, value=value)
