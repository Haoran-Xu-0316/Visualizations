...
plt.fill_between(pd.date_range(start='2019-9', end='2020-08', freq='M'), -0.3,0.60, color=C_fill, alpha=0.4, linewidth=0)
plt.margins(x=0,y=0)
...
plt.margins(x=0,y=0)
plt.tight_layout()
plt.savefig(r'C:/Users/徐浩然/Desktop/Figure 2-China/DCC-GPR.png',dpi=300)
plt.show()