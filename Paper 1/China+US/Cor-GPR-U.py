...
S=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-GPR.xlsx', sheet_name='Short-Cor',index_col=0,parse_dates=[0])
L=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Varanice&Covariance-GPR.xlsx', sheet_name='Long-Cor',index_col=0,parse_dates=[0])
...
Ss=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-GPR.xlsx', sheet_name='Short-Cor',index_col=0,parse_dates=[0])
Ls=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Varanice&Covariance-GPR.xlsx', sheet_name='Long-Cor',index_col=0,parse_dates=[0])
...
plt.tight_layout()
plt.savefig(r'C:/Users/徐浩然/Desktop/Figure 2-U/DCC-GPR.pdf',dpi=2000)
plt.show()