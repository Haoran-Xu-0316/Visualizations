...
Bond=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Hedge_HE.xlsx', sheet_name='Bond',index_col=0,parse_dates=[0])
Oil=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Hedge_HE.xlsx', sheet_name='Oil',index_col=0,parse_dates=[0])
BTC=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Hedge_HE.xlsx', sheet_name='BTC',index_col=0,parse_dates=[0])
Gold=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\Hedge_HE.xlsx', sheet_name='Gold',index_col=0,parse_dates=[0])

Bonds=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedge_HE.xlsx', sheet_name='Bond',index_col=0,parse_dates=[0])
Oils=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedge_HE.xlsx', sheet_name='Oil',index_col=0,parse_dates=[0])
BTCs=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedge_HE.xlsx', sheet_name='BTC',index_col=0,parse_dates=[0])
Golds=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\Hedge_HE.xlsx', sheet_name='Gold',index_col=0,parse_dates=[0])
...
sl=plt.legend(labels=['CSI 300 - GBond'],frameon=False,loc='upper right',handlelength=0,prop={'style':'italic','weight':'bold'})
...
sl=plt.legend(labels=['S&P 500 - GBond'],frameon=False,loc='upper right',handlelength=0,prop={'style':'italic','weight':'bold'})
plt.legend(frameon=False,loc='upper left',labelspacing=0.15)
plt.gca().add_artist(sl)
plt.xlim(time)
...
sl=plt.legend(labels=['S&P 500 - Gold'],frameon=False,loc='upper right',handlelength=0,prop={'style':'italic','weight':'bold'})
plt.legend(frameon=False,loc='upper left',labelspacing=0.15)
plt.gca().add_artist(sl)
plt.xlim(time)
...
sl=plt.legend(labels=['CSI 300 - Bitcoin'],frameon=False,loc='upper right',handlelength=0,prop={'style':'italic','weight':'bold'})
plt.legend(frameon=False,loc='upper left',labelspacing=0.15)
plt.gca().add_artist(sl)
plt.xlim(time)
...
sl=plt.legend(labels=['S&P 500 - Bitcoin'],frameon=False,loc='upper right',handlelength=0,prop={'style':'italic','weight':'bold'})
plt.legend(frameon=False,loc='upper left',labelspacing=0.15)
plt.gca().add_artist(sl)
plt.xlim(time)
...
#
plt.tight_layout()
plt.savefig(r'C:/Users/徐浩然/Desktop/Figure 2-U/HE_hedging.pdf',dpi=2000)
plt.show()
