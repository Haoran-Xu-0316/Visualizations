...
Bonds=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\OHR.xlsx', sheet_name='Bond',index_col=0,parse_dates=[0])
Oils=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\OHR.xlsx', sheet_name='Oil',index_col=0,parse_dates=[0])
BTCs=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\OHR.xlsx', sheet_name='BTC',index_col=0,parse_dates=[0])
Golds=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\OHR.xlsx', sheet_name='Gold',index_col=0,parse_dates=[0])
...
plt.xlim(time)
plt.yticks([-3.0, -2.0, -1.0, 0.0, 1.0],['\N{MINUS SIGN}3.0', '\N{MINUS SIGN}2.0', '\N{MINUS SIGN}1.0','0.0', '1.0'])
...
plt.gca().add_artist(sl)
plt.xlim(time)
plt.yticks([-6.0, -4.0, -2.0, 0.0, 2.0],['\N{MINUS SIGN}6.0', '\N{MINUS SIGN}4.0','\N{MINUS SIGN}2.0','0.0', '2.0'])
plt.axhline(y=0,color='black',linestyle='-',linewidth=1.5)
...
sl=plt.legend(labels=['CSI 300 - Gold'],frameon=False,loc='lower right',handlelength=0,prop={'style':'italic','weight':'bold'})
...
sl=plt.legend(labels=['S&P 500 - Gold'],frameon=False,loc='lower right',handlelength=0,prop={'style':'italic','weight':'bold'})
plt.legend(frameon=False,loc='lower left',labelspacing=0.15)
plt.gca().add_artist(sl)
plt.xlim(time)
...
sl=plt.legend(labels=['CSI 300 - Oil'],frameon=False,loc='lower right',handlelength=0,prop={'style':'italic','weight':'bold'})
plt.legend(frameon=False,loc='upper left',labelspacing=0.15)
plt.gca().add_artist(sl)
plt.xlim(time)
plt.axhline(y=0,color='black',linestyle='-',linewidth=1.5)
...
sl=plt.legend(labels=['CSI 300 - Bitcoin'],frameon=False,loc='lower right',handlelength=0,prop={'style':'italic','weight':'bold'})
plt.legend(frameon=False,loc='upper left',labelspacing=0.15)
plt.gca().add_artist(sl)
plt.xlim(time)
...
sl=plt.legend(labels=['S&P 500 - Bitcoin'],frameon=False,loc='lower right',handlelength=0,prop={'style':'italic','weight':'bold'})
plt.legend(frameon=False,loc='upper left',labelspacing=0.15)
plt.gca().add_artist(sl)
plt.xlim(time)
plt.axhline(y=0,color='black',linestyle='-',linewidth=1.5)
...
#
plt.tight_layout()
plt.savefig(r'C:/Users/徐浩然/Desktop/Figure 2-U/OHR.pdf',dpi=2000)
plt.show()
