...
lBond=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\LPM.xlsx', sheet_name='Bond',index_col=0,parse_dates=[0])
lOil=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\LPM.xlsx', sheet_name='Oil',index_col=0,parse_dates=[0])
lBTC=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\LPM.xlsx', sheet_name='BTC',index_col=0,parse_dates=[0])
lGold=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\LPM.xlsx', sheet_name='Gold',index_col=0,parse_dates=[0])


Bond=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\VaR.xlsx', sheet_name='Bond',index_col=0,parse_dates=[0])
Oil=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\VaR.xlsx', sheet_name='Oil',index_col=0,parse_dates=[0])
BTC=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\VaR.xlsx', sheet_name='BTC',index_col=0,parse_dates=[0])
Gold=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-China\VaR.xlsx', sheet_name='Gold',index_col=0,parse_dates=[0])

lBonds=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\LPM.xlsx', sheet_name='Bond',index_col=0,parse_dates=[0])
lOils=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\LPM.xlsx', sheet_name='Oil',index_col=0,parse_dates=[0])
lBTCs=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\LPM.xlsx', sheet_name='BTC',index_col=0,parse_dates=[0])
lGolds=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\LPM.xlsx', sheet_name='Gold',index_col=0,parse_dates=[0])


Bonds=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\VaR.xlsx', sheet_name='Bond',index_col=0,parse_dates=[0])
Oils=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\VaR.xlsx', sheet_name='Oil',index_col=0,parse_dates=[0])
BTCs=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\VaR.xlsx', sheet_name='BTC',index_col=0,parse_dates=[0])
Golds=pd.read_excel(r'C:\Users\徐浩然\Desktop\DCC-data-US\VaR.xlsx', sheet_name='Gold',index_col=0,parse_dates=[0])
...
plt.tight_layout()
plt.savefig(r'C:/Users/徐浩然/Desktop/Figure 2-U/VaRLPM.png',dpi=300)
plt.show()
