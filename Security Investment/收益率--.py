...
plt.subplot(321)
a=sns.histplot(data=rets.iloc[:, 0:1],fill=True,kde=True,palette=cc,alpha=aa, linewidth=0.5)
plt.ylabel('')

plt.subplot(322)
b=sns.histplot(data=rets.iloc[:, 1:2],fill=True,kde=True,palette=cc,alpha=aa, linewidth=0.5)
plt.ylabel('')

plt.subplot(323)
c=sns.histplot(data=rets.iloc[:, 2:3],fill=True,kde=True,palette=cc,alpha=aa, linewidth=0.5)
plt.ylabel('')

plt.subplot(324)
d=sns.histplot(data=rets.iloc[:, 3:4],fill=True,kde=True,palette=cc,alpha=aa, linewidth=0.5)
plt.ylabel('')

plt.subplot(325)
e=sns.histplot(data=rets.iloc[:, 4:5],fill=True,kde=True,palette=cc,alpha=aa, linewidth=0.5)
plt.ylabel('')

plt.subplot(326)
f=sns.histplot(data=rets.iloc[:, 5:6],fill=True,kde=True,palette=cc,alpha=aa, linewidth=0.5)
plt.ylabel('')
