...
# labels=['600028.SH', '601857.SH', '600023.SH']#选的
...
# labels=['601318.SH','600887.SH','600104.SH','600028.SH','601800.SH','601668.SH','600019.SH','603993.SH','600900.SH']
# labels=[]
number=len(labels)
...
# print(dfs['成分券代码Constituent Code'])
# for i in dfs['成分券代码Constituent Code']:
#     labels.append(str(i)+'.SH')
