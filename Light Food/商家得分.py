...
df = pd.read_excel(r'C:\Users\徐浩然\Desktop\营销HM.xlsx', sheet_name='AHP scores',index_col=0)

barh=df.plot.barh(width=0.8, legend=False,linewidth=0, xticks=range(0,1,10),figsize=(12, 4),edgecolor="Black" , color='#B3D0AB')
...
plt.tight_layout()
# plt.savefig(r'C:/Users/徐浩然/Desktop/轻食Figure/商家得分.png',dpi=400)
plt.savefig(r'C:/Users/徐浩然/Desktop/商家得分.png',dpi=400)
plt.show()
