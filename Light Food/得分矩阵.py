...
df = pd.read_excel(r'C:\Users\徐浩然\Desktop\营销HM.xlsx', sheet_name='Sheet2',index_col=0)
plt.subplots(figsize=(10,5))

# plot
heat=sns.heatmap(df, annot=True,fmt=".4f", linecolor='black',robust=True,linewidth=0.3,cmap=C, vmin=0.09, vmax=0.11,cbar_kws={"orientation":"vertical"})
...
plt.tight_layout()
heat.set_ylabel('')
plt.savefig(r'C:/Users/徐浩然/Desktop/得分',dpi=400)
